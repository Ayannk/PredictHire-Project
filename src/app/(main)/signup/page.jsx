...
const Signup = () => {
  ...
  return (
    <div className='max-w-xl mx-auto '>
      <div className=" mt-7 bg-white mb-4 border border-gray-200 rounded-xl shadow-sm dark:bg-neutral-900 dark:border-neutral-700">
    ...
    <div className="mt-5">
      ...
      <form onSubmit={signupForm.handleSubmit}>
        <div className="grid gap-y-4">
          ...
          >
            {
              signupForm.isSubmitting ? <IconLoader className='animate-spin'/> : <IconSend2/>
            }
            Sign up
          </button>
        </div>
